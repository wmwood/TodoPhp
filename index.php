...
define('APP', ROOT . 'presentation' . DIRECTORY_SEPARATOR);
define('CORE', ROOT . 'core' . DIRECTORY_SEPARATOR);
define('INFRASTRUCTURE', ROOT . 'infrastructure' . DIRECTORY_SEPARATOR);
...
require INFRASTRUCTURE . '/infrastructure.php';
